...
<div class="hero-area">
    ...
    <div class="hero-post-slides owl-carousel">
        ...
        <!-- Single Slide -->
        <div class="single-slide bg-img bg-overlay" style="background-image: url('image/banner10.jpg');">
            <!-- Blog Content -->
                ...
                <div class="row h-100 align-items-center">
                    <div class="col-12 col-lg-9">
                        <div class="blog-content" data-animation="fadeInUp" data-delay="100ms">
                            ...
                            <p data-animation="fadeInUp" data-delay="700ms">Temukanlah game yang menarik disini yang telah kami rekomendasikan</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- Single Slide -->
        <div class="single-slide bg-img bg-overlay" style="background-image: url('image/banner11.jpg');">
            <!-- Blog Content -->
            <div class="container h-100">
                <div class="row h-100 align-items-center">
                    <div class="col-12 col-lg-9">
                        <div class="blog-content" data-animation="fadeInUp" data-delay="100ms">
                            <h2 data-animation="fadeInUp" data-delay="400ms">The Power of Gaming</h2>
                            <p data-animation="fadeInUp" data-delay="700ms">Kalau memang kamu suka permainan, silahkan bermainlah, tapi ingat sampai kapan bermain main?</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-md-6 col-lg-8">
                <div class="tab-content" id="video-tabContent">
                    <div class="tab-pane fade show active" id="video-1" role="tabpanel" aria-labelledby="video1">
                        <div class="video-playground bg-img" style="background-image: url('image/gambar.jpg');">
                           <!-- Play Button -->
